...
class token:
	...
	def setRestricted(self):
		...
		chat.sendMessage("Keesu", self.username, "Your account is currently in restricted mode. Please visit ripple's website for more information.")
	...
	def resetRestricted(self):
		...
		:return:
		"""
		chat.sendMessage("Keesu", self.username, "Your account has been unrestricted! Please log in again.")
